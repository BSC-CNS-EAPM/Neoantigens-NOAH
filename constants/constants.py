...
DATA_PATH = os.path.dirname(NOAH.data.__file__)
TEST_PATH = os.path.dirname(NOAH.test.__file__)
CONSTANTS_PATH = os.path.dirname(NOAH.constants.__file__)
...
VALID_AMINOACIDS = ['A', 'C', 'E', 'D', 'G', 'F', 'I', 'H', 'K', 'M', 'L', 'N', 'Q', 'P', 'S', 'R', 'T', 'W', 'V', 'Y']
...
SIMILARITY_DICT = {"blosum62":BLOSUM62, "pam250": PAM250, "granthams": GRANTHAMS, "sneath":SNEATH}
